...
func main() {
	...
	// Get the list of projects to retrieve the group ID
	projectParams := &ListProjectsParams{
	...
	if config.GroupID == "" {
		config.GroupID = *projectId
	}

	processParams := &ListAtlasProcessesParams{
		GroupID:      config.GroupID,
		IncludeCount: admin.PtrBool(true),
		ItemsPerPage: admin.PtrInt(1),
		PageNum:      admin.PtrInt(1),
	...
	clusterMetricParams := ClusterMetricParams{
		GroupID:       config.GroupID,
		ProcessID:     *processID,
		PartitionName: "data",
...
func getProjectList(ctx context.Context, sdk *admin.APIClient, projectParams *ListProjectsParams) (*admin.PaginatedAtlasGroup, error) {
...
func getProcessList(ctx context.Context, sdk *admin.APIClient, processParams *ListAtlasProcessesParams) (*admin.PaginatedHostViewAtlas, error) {
...
func getHostMetrics(ctx context.Context, sdk *admin.APIClient, metricParams HostMetricParams) error {
...
func getClusterMetrics(ctx context.Context, sdk *admin.APIClient, clusterMetricParams ClusterMetricParams) error {
